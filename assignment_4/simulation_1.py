from assignment_4 import network_1
from assignment_4 import link_1
import threading
...
simulation_time = 1  # give the network sufficient time to execute transfers, will need to extend this later
